...
const User = sequelize.define(
  "user",
  {
    ...
    firstName: {
      ...
      allowNull: false,
      validate: createValidation(validationRules.user.firstName, "first name"),
    },

    lastName: {
      type: DataTypes.STRING,
      allowNull: false,
      validate: createValidation(validationRules.user.lastName, "last name"),
    },
    ...
    password: {
      type: DataTypes.STRING,
      allowNull: false,
      validate: createValidation(validationRules.user.password, "password"),
    },
